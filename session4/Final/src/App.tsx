...
function App(){
  ...
  return (
    ...
    <div className="description">
      <p>
        Con esta aplicación de matriculación, puedes registrar todos los nuevos integrantes. 
        Usa las opciones de la derecha para cambiar entre los programas de Grado y Postgrado.
      </p>
    </div>
    <h1>APLICACIÓN DE MATRICULACIÓN</h1>
    <EnrolmentForm chosenProgram={program} onChangeEnrolments={handleChangeEnrolments} currentEnrolments={selectedEnrolments()} onStudentChanged={handleStudentChange} editingStudent={editingStudent}/>
